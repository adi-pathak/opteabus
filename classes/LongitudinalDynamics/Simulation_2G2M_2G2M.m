...
vehicle.troque_range{2} = [(vehicle.MOTOR{3}.eff_T_axis(end)*max(vehicle.GEARBOX{3}.gear_ratio)+(vehicle.MOTOR{4}.eff_T_axis(end)*max(vehicle.GEARBOX{4}.gear_ratio)));(vehicle.MOTOR{3}.eff_T_axis(1)*min(vehicle.GEARBOX{3}.gear_ratio)+(vehicle.MOTOR{4}.eff_T_axis(1)*min(vehicle.GEARBOX{4}.gear_ratio)))];
...
V_Axle_Rear_Left_Right=[V_Axle_Rear(1,:)./2;V_Axle_Rear(2:end,:)];
 ...
 [V_Gearbox_Rear_Left]= Partition_Gearbox(vehicle.GEARBOX{1,3}, V_Axle_Rear_Left_Right);
 
 [V_Gearbox_Rear_Right]= Partition_Gearbox(vehicle.GEARBOX{1,4}, V_Axle_Rear_Left_Right);
 ...
 [P_EL_Motor_Rear_Left, DATA_Rear_Left] = Determination_Power (V_Gearbox_Rear_Left, vehicle.MOTOR{1,3});
 
 [P_EL_Motor_Rear_Right, DATA_Rear_Right] = Determination_Power (V_Gearbox_Rear_Right, vehicle.MOTOR{1,4});
 ...
 [P_EL_Gearbox_Rear_Left, DATA_Rear_Left] = Determination_Gear (P_EL_Motor_Rear_Left, vehicle.GEARBOX{1,3}, DATA_Rear_Left);

 [P_EL_Gearbox_Rear_Right, DATA_Rear_Right] = Determination_Gear (P_EL_Motor_Rear_Right, vehicle.GEARBOX{1,4}, DATA_Rear_Right);
...
P_EL_Gearbox_Rear(1,:)=P_EL_Gearbox_Rear_Left(1,:)+P_EL_Gearbox_Rear_Right(1,:);
P_EL_Gearbox_Rear(2,:)=P_EL_Gearbox_Rear_Left(2,:);


 [P_EL_MIN, DATA] = Determination_Distribution (P_EL_Gearbox_Front,P_EL_Gearbox_Rear, [DATA_Front_Left;DATA_Front_Right;DATA_Rear_Left;DATA_Rear_Right]);
...
DATA(10,(v==0&a==0))=0;
 ...
 DATA_R.Tn=zeros(8,length(DATA(1,:)));
