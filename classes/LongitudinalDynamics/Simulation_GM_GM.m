...
vehicle.troque_range{2} = [vehicle.MOTOR{3}.eff_T_axis(end)*max(vehicle.GEARBOX{3}.gear_ratio);vehicle.MOTOR{3}.eff_T_axis(1)*min(vehicle.GEARBOX{3}.gear_ratio)];
...
%% Powertrain
 ...
 [P_EL_Getriebe_Rear, DATA_Rear] = Determination_Gear (P_EL_Motor_Rear, vehicle.GEARBOX{1,3}, DATA_Rear); 
