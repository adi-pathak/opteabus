function [Econs,range,vmax,amax,grade,throughput] = EnergyConsumption( Vehicle, driving_cycle )
whichSim='E';
...
%% Vehicle parameters
vehicle.m                 = Vehicle.Grossvehiclemass ;%Param.mass.adaptedmass;                             % in kg - Use Mass_calculation() regression functions
...
switch Vehicle.Powertrain.topology
   case 1
        ...
        vehicle.GEARBOX{1}.gear_ratio       =...
           Vehicle.Powertrain.RA1.transmission.ratio; %[Param.motor.FAGearRatio1 Param.motor.FAGearRatio2];
